...
- [How you can contribute to Devito documentation?](#how-you-can-contribute-to-devito-documentation)
...
## How you can contribute to Devito documentation?

The instructions below were copied from [stackoverflow](https://stackoverflow.com/a/11481887)
1. Manually create a fork of the Devito wiki on your Github account:
  * Create a new repository on your github account. Let's call it "Devito-Wiki".
  * Clone the Devito wiki repo to your local machine somewhere: `git clone https://github.com/devitocodes/devito.wiki.git`
  * Remove the original "origin" remote and add your github repo as new "origin" `git remote rm origin` and `git remote add origin git@github.com:<YOUR_USERNAME>/Devito-Wiki.git`
...
3. Submit a ticket to the official Devito issue tracker requesting us to review your changes and merge them in. Please be sure to include a link to your repo and describe what you've changed.
4. Goto #2
