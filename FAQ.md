...
- [There is a bug and I really think it is not my fault. What should I do](#there-is-a-bug-and-i-really-think-it-is-not-my-fault-what-should-i-do)
...
## There is a bug and I really think it is not my fault. What should I do
...
* If your Operator has many Eqs, start with removing some of them. Is the bug still there? Great, keeping on removing the unnecessary. Some Functions may now become unnecessary, because they were only appearing in the removed Eqs. Then, drom them too from the Python file.
