...
- [As time increases in the finite difference evolution, are wavefield arrays "swapped" like you might see in c/c++ code?](#As-time-increases-in-the-finite-difference-evolution,-are-wavefield-arrays-"swapped"-like-you-might-see-in-c/c++-code?)
- [What are units typically used in devito examples](#What-are-units-typically-used-in-devito-examples)
...
The code generated by devito is designed to run fast on CPU and GPU. Broadly outlined, some of the mechanics for generating fast code are:
- CPU
- Cache blocking
- Loop fusing
